...
export default function Navbar({ isLoggedIn = false, userInitial = "R", userName = "Ahmed Mansour", userCompany = "MANSOUR Administrateur", dict, locale }: NavbarProps) {    const router = useRouter();
