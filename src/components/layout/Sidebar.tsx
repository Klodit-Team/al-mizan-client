...
export default function Sidebar({ locale, role, dict }: SidebarProps) {
    ...
    const navItems = role === "contractant" ? [
        {
            label: dict.browseAOs,
            href: `/${locale}/dashboard/tenders`,
            icon: (
        ...
        <aside className="w-56 min-h-screen flex flex-col border-r border-gray-700" style={{ backgroundColor: "white" }}>
            ...
            <Link
                href={role === "admin" 
                    ...
                    : `/${locale}/dashboard/tableau-de-bord`}
