...
export default function Sidebar({ locale, role, dict }: SidebarProps) {
        ...
        [
          {
            ...
            href: `/${locale}/dashboard/admin/id/organisations`,
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          },
          {
            ...
            href: `/${locale}/dashboard/admin/id/operateurs`,
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          },
          {
            ...
            href: `/${locale}/dashboard/admin/id/journal-audit`,
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          },
          {
            ...
            href: `/${locale}/dashboard/admin/id/incidents`,
            icon: (
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const dashboardHref =
    role === "admin"
      ? `/${locale}/dashboard/admin/id/tableau-de-bord`
      : role === "contractant"
  ...
  return (
    ...
    >
      ...
      <Link
        href={dashboardHref}
        className={`flex items-center gap-3 px-4 py-3 text-sm font-semibold transition-colors duration-150 ${
          isActive(dashboardHref)
            ? "bg-[#4CAF50] text-white"
            : "border-b border-gray-200 bg-white text-[#2F9E44] hover:bg-emerald-50"
        }`}
      >
        <svg
          className="w-5 h-5"
          ...
          <Link
            ...
            className={`group flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm transition-colors duration-150 ${
              isActive(item.href)
                ...
                : "text-gray-500 hover:bg-emerald-50 hover:text-[#2F9E44]"
            }`}
          >
            <span
              className={
                isActive(item.href)
                  ? "text-[#4CAF50]"
                  : "text-gray-400 transition-colors duration-150 group-hover:text-[#2F9E44]"
              }
            >
              {item.icon}
            </span>
