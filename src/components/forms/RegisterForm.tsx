                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <select
                                {...register("wilaya")}
                                defaultValue=""
                                className={`w-full px-4 py-3 rounded-xl border text-sm outline-none transition-all focus:ring-2 text-[#0F172A] bg-white ${errors.wilaya ? "border-red-400 focus:ring-red-100" : "border-gray-200 focus:ring-green-100 focus:border-[#4CAF50]"}`}
                            >
                                <option value="" disabled hidden>
                                    {dict.fields.wilayaPlaceholder || "Sélectionnez une wilaya"}
                                </option>
